			...
			<tr>
				<td colspan=4 id='contentCell' >
								...
								<div class='row'>
									...
									<div class='cell'>
										<?php
										 ...
										 if (file_exists($tf)) {
										 echo '<input type="submit" name="tidalButton" value="" id="tidalButton" class="selButton"/><input type="submit" id="tidalText" name="tidalButton" value="Tidal Connect (DA)" class="selButtonText"/>';
										 } else {
										 echo '<input type="submit" name="tidalButton" value="" id="tidalButton" class="unselButton"/><input type="submit" id="tidalText" name="tidalButton" value="Tidal Connect (DA)" class="unselButtonText"/>';
										 }
										?>    
									</div>
								</div>
					...
					<div id='systemSel'>
						...
						<div class='row'>
								<br>
								<span class="title">DAStereo version</span>
								<div id='upd'>
									<form method="post">
										<?php
...
<?php
	if(isset($_POST['naaButton'])){
		...
		/etc/init.d/S90aprenderer stop ;
		rm /etc/init.d/S90* ;
		cp /etc/rc.botic/S90tidal /etc/init.d/ ; 
		sed -i 's/\/usr\/bin\/start_tc/\/usr\/bin\/proxychains4 \/usr\/bin\/start_tc/g' /etc/init.d/S90tidal && sync ;
		/etc/init.d/S90tidal start` ; }
		echo '<script type="text/javascript">removeSelButtons();</script>';
